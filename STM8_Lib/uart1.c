/**
  ...
  \brief implementation of UART1 functions/macros
   
  implementation of UART1 functions and macros. 
...
void uart1_init(uint32_t BR) {
  ...
  // init UART1 Rx pin (=PA4)
  PORT_A.DDR.bit.b4 = 0;  // input(=0) or output(=1)
  PORT_A.CR1.bit.b4 = 1;  // input: 0=float, 1=pull-up; output: 0=open-drain, 1=push-pull
  PORT_A.CR2.bit.b4 = 0;  // input: 0=no exint, 1=exint; output: 0=2MHz slope, 1=10MHz slope
  
  // init UART1 Tx pin (=PA5)
  PORT_A.ODR.bit.b5 = 1;  // init output to high
  PORT_A.DDR.bit.b5 = 1;  // input(=0) or output(=1)
  PORT_A.CR1.bit.b5 = 1;  // input: 0=float, 1=pull-up; output: 0=open-drain, 1=push-pull
  PORT_A.CR2.bit.b5 = 1;  // input: 0=no exint, 1=exint; output: 0=2MHz slope, 1=10MHz slope
...
/**
  \fn void  uart1_send(uint8_t data)
