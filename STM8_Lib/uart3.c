/**
  ...
  \brief implementation of UART3 functions/macros
   
  implementation of UART3 functions and macros. 
...
void uart3_init(uint32_t BR) {
  ...
  // init UART3 Rx pin (=PA4)
  PA.DDR.bit.b4 = 0;  // input(=0) or output(=1)
  PA.CR1.bit.b4 = 1;  // input: 0=float, 1=pull-up; output: 0=open-drain, 1=push-pull
  PA.CR2.bit.b4 = 0;  // input: 0=no exint, 1=exint; output: 0=2MHz slope, 1=10MHz slope
  
  // init UART3 Tx pin (=PA5)
  PA.ODR.bit.b5 = 1;  // init output to high
  PA.DDR.bit.b5 = 1;  // input(=0) or output(=1)
  PA.CR1.bit.b5 = 1;  // input: 0=float, 1=pull-up; output: 0=open-drain, 1=push-pull
  PA.CR2.bit.b5 = 1;  // input: 0=no exint, 1=exint; output: 0=2MHz slope, 1=10MHz slope
...
/**
  \fn void  uart3_send(uint8_t data)
