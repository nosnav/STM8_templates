/**********************
  ...
  send/receive via UART1 using interrupts and SW FIFO.
  Note that the only change to example "UART1_Blocking"
  is defining the macro "UART1_FIFO" in Makefile. 
  
  Functionality:
   - change CPU clock prescaler
   - initialize UART1 for 115.2kBaud and interrupts
